        ...
        <Card className="border-2 border-green-500 shadow-md">
          ...
          <CardContent className="space-y-4">
            ...
            <li className="flex items-center"><CheckCircle2 className="mr-2 h-4 w-4 text-green-500" /> 💰 Income/Expense Tracking</li>
              ...
              <li className="flex items-center"><CheckCircle2 className="mr-2 h-4 w-4 text-green-500" /> 🏦 Add Income Source</li>
              ...
              <li className="flex items-center"><CheckCircle2 className="mr-2 h-4 w-4 text-green-500" /> 📈 Spending Forecast</li>
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <Accordion type="single" collapsible>
          <AccordionItem value="q1">
            ...
            <AccordionContent>Yes, you can cancel anytime from your account settings. You'll retain access until your account is deleted.</AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="q3">
            ...
            <AccordionContent>Absolutely. Your financial data is encrypted, protected, and never shared. We follow industry-leading security standards to keep your information safe.</AccordionContent>
          </AccordionItem>
        </Accordion>
      </div>
    </div>
