            ...
            <div className="mx-auto max-w-3xl space-y-8 py-12">
              <div className="space-y-4">
                ...
                <p className="text-gray-500 dark:text-gray-400">
                  ...
                  something better—a platform that combines powerful financial tools with an intuitive user experience.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-500 dark:text-gray-400">
                  ...
                  <li>Data visualization and insights should empower people to make better financial decisions.</li>
